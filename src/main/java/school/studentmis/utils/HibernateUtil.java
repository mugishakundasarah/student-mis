package school.studentmis.utils;
    ...
    public static SessionFactory getSessionFactory() {
        if (sessionFactory == null) {
            try {
                ...
                settings.put(Environment.URL, "jdbc:postgresql://localhost:5432/students_db");
                settings.put(Environment.USER, "sarah");
